...
export default async function UrlList() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-blue-100">
            <div className="p-10 bg-white rounded-lg shadow-2xl max-w-4xl w-full">
                <h1 className="text-3xl font-bold mb-6 text-center text-blue-950">All Short Urls</h1>
                <Link href="/" className="text-blue-950 underline hover:text-blue-400"> Go To Home</Link>
                    ...
                    <table className="table table-zebra w-full">
                        ...
                        <tbody>
                            ...
                            {urls.urls && urls.urls.map((url: {_id: string, originalUrl: string, shortUrl: string}) => {
                                return (
                                    <tr key={url._id} className="text-gray-600">
